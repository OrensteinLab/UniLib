...
def main():
    ...
    # read train set of 2135 variants data with 22 barcodes
    ...
    test1["Average_AMM_prediction"] = avg_predictions1
    test2["Average_AMM_prediction"] = avg_predictions2

    # Save the DataFrame with true labels verses predictions to a CSV file
    test1.to_csv('AMM_model_test_300_predictions.csv', index=False)
    test2.to_csv('AMM_model_test_11_predictions.csv', index=False)
