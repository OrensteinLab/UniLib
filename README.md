...
3. **Model Training**:
   ...
   - Uses transfer learning approach - trains model on 3 different datasets - from the largest and low-quality dataset to the smallest and high-quality dataset.
