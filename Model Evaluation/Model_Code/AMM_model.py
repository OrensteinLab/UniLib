...
def train_predict_300_test():
    ...
    # read 2135 with 22 barcodes (without 300 variants test)
    ...
    test["AMM_model_prediction"] = predictions

    test.to_csv('AMM_predictions_test_300.csv', index=False)
...
def main():
    ...
    # read 2435 variants with 22 barcodes
    ...
    validation["Average_AMM_prediction"] = avg_predictions_val

    validation.to_csv('AMM_predictions_11_validation.csv', index=False)
